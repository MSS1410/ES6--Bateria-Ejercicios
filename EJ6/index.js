...
const encontrar = numbers.find(number=>number === 100)
...
const encontrarCucu = aliens.find(alien=> alien.name === 'Cucushumushu')
const encontrarMutacion = mutations.find(mutation => mutation.name === 'Porompompero')

const fusionEncontrada = { ...encontrarCucu, mutation : encontrarMutacion};

console.log(fusionEncontrada)